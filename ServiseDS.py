...
class Bomber(Thread):
    ...
    def setphones(self):
        ...
        88        `8b  Y8,                                                                                   `8b       d8'           a8P  
        88         88  `Y8aaaaa,    8b,dPPYba,   ,adPPYYba,  88,dPYba,,adPYba,    ,adPPYba,  8b,dPPYba,       `8b     d8'         aad8"   
        88         88    `"""""8b,  88P'    "8a  ""     `Y8  88P'   "88"    "8a  a8P_____88  88P'   "Y8        `8b   d8'          ""Y8,   
        88         8P          `8b  88       d8  ,adPPPPP88  88      88      88  8PP"""""""  88                 `8b d8'              "8b  
        88      .a8P   Y8a     a8P  88b,   ,a8"  88,    ,88  88      88      88  "8b,   ,aa  88                  `888'       Y8,     a88  
        88888888Y"'     "Y88888P"   88`YbbdP"'   `"8bbdP"Y8  88      88      88   `"Ybbd8"'  88                   `8'         "Y888888P'  
                                    88                                                                                                    
                                    88                                                                                                    
        ...
        Bomber.phone = input("Ввести номер телефона (79xxxxxxxxx) или (+38xxxxxxxxxx) --> ")
        phone = Bomber.phone
